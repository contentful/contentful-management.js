 ...
 * @prop {object} parameters - App specific configuration variables
...
export function wrapAppInstallation (http, data) {
  ...
  /**
   * we need an id property on the sys meta object to make a proper
   * HTTP call to the endpoint
   */
  appInstallation.sys.id = appInstallation.sys.appDefinition.sys.id
