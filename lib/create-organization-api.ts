...
export default function createOrganizationApi({ http }: { http: AxiosInstance }) {
   ...
   * ```
   */
  function getOrganizationMembership(id: string) {
    return http
   ...
   * ```
   */
  function getOrganizationMemberships(query: QueryOptions = {}) {
    return http
   ...
   * ```
   */
  function getOrganizationSpaceMembership(id: string) {
    return http
   ...
   * ```
   */
  function getOrganizationSpaceMemberships(query: QueryOptions = {}) {
    return http
   ...
   * ```
   */
  function createTeamMembership(teamId: string, data: Omit<TeamMembershipProps, 'sys'>) {
    return http
   ...
   * ```
   */
  function getTeamMembership(teamId: string, teamMembershipId: string) {
    return http
   ...
   * ```
   */
  function getTeamMemberships(opts: { teamId?: string; query?: QueryOptions } = {}) {
   ...
   * ```
   */
  function getTeamSpaceMemberships(opts: { teamId?: string; query?: QueryOptions } = {}) {
    const query = get(opts, 'query', {})
    if (opts.teamId) {
   ...
   * ```
   */
  function createTeam(data: Omit<TeamProps, 'sys'>) {
    return http.post('teams', data).then((response) => wrapTeam(http, response.data), errorHandler)
  }
   ...
   * ```
   */
  function getTeams(query: QueryOptions = {}) {
    return http
   ...
   * ```
   */
  function getOrganizationInvitation(invitationId: string) {
    return http
   ...
   * ```
   */
  function createOrganizationInvitation(data: Omit<OrganizationInvitationProps, 'sys'>) {
   ...
   * ```
   */
  function getAppDefinitions(query: QueryOptions = {}) {
    return http
   ...
   * ```
   */
  function getAppDefinition(id: string) {
    return http
   ...
   * ```
   */
  function createAppDefinition(data: Omit<AppDefinitionProps, 'sys'>) {
    return http
   ...
   * ```
   */
  function getUsers(query: QueryOptions = {}) {
    return http
