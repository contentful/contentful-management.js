...
export default function createSpaceApi ({
  ...
  */
   ...
   * .catch(console.error)
   */
  function createTeamSpaceMembership (teamId, query = {}) {
    return http.post('team_space_memberships', createRequestConfig({query: query}), {
      headers: {
  ...
  function getTeamSpaceMembership (teamSpaceMembershipId) {
    ...
    return http.get('team_space_memberships/' + teamSpaceMembershipId, {headers: teamAlphaHeaders})
      .then((response) => wrapTeamSpaceMembership(http, response.data), errorHandler)
  }
  ...
  function getTeamSpaceMemberships (query = {}) {
    ...
    return http.get('team_space_memberships', {headers: teamAlphaHeaders, query})
