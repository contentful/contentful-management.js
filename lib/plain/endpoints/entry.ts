...
export const get = <T extends KeyValueMap = KeyValueMap>(
  http: AxiosInstance,
  params: GetSpaceParams & GetEnvironmentParams & { entryId: string } & QueryParams
) => {
...
export const update = <T extends KeyValueMap = KeyValueMap>(
  http: AxiosInstance,
  params: GetSpaceParams & GetEnvironmentParams & { entryId: string },
...
export const create = <T extends KeyValueMap = KeyValueMap>(
  http: AxiosInstance,
  params: GetSpaceParams & GetEnvironmentParams & { contentTypeId: string },
...
export const createWithId = <T extends KeyValueMap = KeyValueMap>(
  http: AxiosInstance,
  params: GetSpaceParams & GetEnvironmentParams & { entryId: string; contentTypeId: string },
  rawData: CreateEntryProps<T>
) => {
  const data = cloneDeep(rawData)
