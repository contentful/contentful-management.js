 ...
 * @prop {function} getOrganizationPeriodicUsages
 * @prop {function} getSpacePeriodicUsages
 */
...
export default function createClientApi ({ http }) {
  ...
  const {wrapPeriodicUsageCollection} = entities.periodicUsage
  ...
  /**
   * Get a collection of periodic usages for an organization
   *
   * @memberof ContentfulClientAPI
   * @param {string} organizationId - Id of an organization
   * @param {Usage.PeriodicUsageQuery} query - Query parameters
   * @return {Promise<Usage.PeriodicUsageCollection>} Promise of a collection of periodic usages
   * @example
   *
   * const contentful = require('contentful-management')
   *
   ...
   * })
   *
   * client.getOrganizationPeriodicUsages('<organizationId>', {
   *    'metric[in]': 'cma,gql',
   ...
   * .catch(console.error)
   */
  function getOrganizationPeriodicUsages (organizationId, query = {}) {
    ...
    return http.get('', {baseURL, params: query})
      .then((response) => wrapPeriodicUsageCollection(http, response.data), errorHandler)
  }

  /**
   * Get a collection of periodic usages for an organization grouped by space and metric
   *
   * @memberof ContentfulClientAPI
   * @param {string} organizationId - Id of an organization
   * @param {Usage.PeriodicUsageQuery} query - Query parameters
   ...
   * })
   *
   * client.getSpacePeriodicUsages('<organizationId>', {
   *    skip: 0,
   *    limit: 10,
   ...
   *
   */
  function getSpacePeriodicUsages (organizationId, query = {}) {
  ...
  return {
    ...
    getUsages: getUsages,
    getOrganizationPeriodicUsages: getOrganizationPeriodicUsages,
    getSpacePeriodicUsages: getSpacePeriodicUsages
  }
}
