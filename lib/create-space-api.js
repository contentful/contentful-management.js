...
/**
 * @typedef {ContentFulSpaceAPI} ContentfulSpaceAPI
 ...
 * @property {function(): Promise<ContentType>} createContentType - creates a ContentType
 * @property {function(id: string): Promise<ContentType>} createContentTypeWithId - creates a ContentType with a custom id
 * @property {function(id: string): Promise<Entry>} getEntry - Gets an Entry with a custom id
 * @property {function(): Promise<EntryCollection>} getEntries - Gets a collection of entries
 * @property {function(): Promise<Entry>} createEntry - Creates an Entry
 * @property {function(id: string): Promise<Entry>} createEntryWithId - Creates an Entry with a custom id
 * @property {function(id: string): Promise<Asset>} getAsset - Gets an asset by id
 * @property {function(): Promise<AssetCollection>} getAssets - Gets a collection of assets
 * @property {function(): Promise<Asset>} createAsset - Creates an asset
 * @property {function(id: string):Promise<Asset>} createAssetWithId - Creates an asset with the custom id
 ...
 * @property {function(): Promise<Locale>} createLocale - Creates a Locale
 ...
 * @property {function(): Promise<Webhook>} createWebhook - Creates a webhook
 * @property {function(id: string)} createWebhookWithId - Creates a webhook with a custom id
 ...
 * @property {function(): Promise<Role>} createRole - Creates a role
 * @property {function(id: string): Promise<Role>} createRoleWithId - Creates a Role with a custom id
 ...
 * @property {function(): Promise<Membership>} createSpaceMembership - Creates a space membership
 * @property {function(id: string): Promise<SpaceMembership>} createSpaceMembershipWithId - Creates a space membership with a custom id
 ...
 * @property {function(): Promise<ApiKey>} createApiKey - Creates an api key
 * @property {function(id: string): Promise<ApiKey>} createApiKeyWithId - Creates an api key with a custom id
 */
