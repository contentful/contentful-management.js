...
function createOrganizationMembershipApi (http) {
  return {
     ...
     * .then((space) => space.getOrganizationMembership('<OrganizationMembership_id>'))
 ...
 * @return {OrganizationMembership} Wrapped space membership data
 */
 ...
 * @return {OrganizationMembershipCollection} Wrapped space membership collection data
 */
