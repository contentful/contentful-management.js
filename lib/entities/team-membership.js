 ...
 * @private
 * @param {Object} http - HTTP client instance
 * @param {Object} data - Raw teamMembership data
 * @return {TeamMembership} Wrapped TeamMembership data
 */
export function wrapOrganizationTeamMembership (http, data) {
  const teamMembership = toPlainObject(cloneDeep(data))
  return freezeSys(teamMembership)
}
 ...
 * @param {Object} http - HTTP client instance
 * @param {Object} data - Raw teamMembership data
 * @return {TeamMembershipCollection} Wrapped TeamMembershipCollection data
 */
export function wrapOrganizationTeamMembershipCollection (http, data) {
  const teamMemberships = toPlainObject(cloneDeep(data))
  teamMemberships.items = teamMemberships.items.map((entity) =>
    wrapOrganizationTeamMembership(http, entity)
  )
  return freezeSys(teamMemberships)
}
