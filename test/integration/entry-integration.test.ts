...
describe('Environment API', () => {
  ...
  it('creates an environment with an id', async () => {
  ...
  describe('With a NER app installed in the environment', () => {
    ...
    beforeAll(async () => {
      ...
      appDefinition.bundle = {
        sys: { id: appBundle.sys.id, type: 'Link', linkType: 'AppBundle' },
      }
    ...
    it('gets all resource types for that environment', async () => {
