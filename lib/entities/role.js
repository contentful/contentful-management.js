 ...
 * @property {function(): Prmise<Role>} - Sends an update to the server with any changes made to the object's properties
 * @property {function(): Prmise} - Deletes this object on the server.
