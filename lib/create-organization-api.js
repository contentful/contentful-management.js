...
export default function createOrganizationApi ({ http }) {
  ...
  const {wrapTeam, wrapTeamCollection} = entities.teamMembership
  ...
  function createTeam (data = {}) {
    return http.post('teams', data, {headers: teamAlphaHeaders})
  ...
  function getTeam (teamId) {
    return http.get('teams/' + teamId, {headers: teamAlphaHeaders})
   ...
   *
   * client.getOrganizations()
   * .then((organization) => organization.getTeams('teamId'))
   * .then((teams) => console.log(teams))
   * .catch(console.error)
   */
  function getTeams (teamId, query = {}) {
    return http.get('teams/' + teamId, {headers: teamAlphaHeaders, query})
