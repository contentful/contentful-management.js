...
export default function createClientApi ({ http }) {
  ...
  /**
   * Gets a collection of usage periods for the organization. Only available to Admin or owner of the organization.
   * @memberof ContentfulClientAPI
   * @param organizationId
   * @return {Promise<UsagePeriodCollection>} Promise for a collection of usage periods
   * @example
   * const contentful = require('contentful-management')
   *
   * const client = contentful.createClient({
  ...
  /**
   * Gets a collection of usages for the organization. Only available to Admin or owner of the organization.
   * @memberof ContentfulClientAPI
   * @param {string} organizationId
   * @param {string} type - either 'organization' or 'space', type of usages to be returned
   * @param {Object} query - Object with search params
   * @param {string} query.filters[metric] - REQUIRED. Possible values are one of cda, cma, cpa, all_apis
   * @param {string} query.filters[usagePeriod] - REQUIRED. ID of usage period
   * @param {string} query.orderBy[metricUsage] - optional. asc or desc. orders resources in response's `items` array by total usage
   * @return {Promise<UsageCollection>} Promise for a collection of usage
   * @example
   *
   * const contentful = require('contentful-management')
   *
  ...
  function getUsages (organizationId, type, query = {}) {
    ...
    return http.get('', createRequestConfig({baseURL, query, headers}))
