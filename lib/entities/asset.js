...
function createAssetApi (http) {
  ...
  return {
     ...
     * asset.update().then(UpdatedAsset => console.log(UpdatedAsset))
     */
     ...
     * @example
     * asset.delete().then(() => console.log('Asset deleted'))
     */
     ...
     * @example
     * asset.publish().then(publishedAsset => console.log(publishedAsset))
     */
     ...
     * @return {Promise<Asset>} Object returned from the server with updated metadata.
     * @example
     * asset.unpublish().then(unpublishedAsset => console.log(unpublishedAsset))
     */
     ...
     * @return {Promise<Asset>} Object returned from the server with updated metadata.
     * @example
     * asset.archive(archivedAsset => console.log(archivedAsset))
     */
     ...
     * @return {Promise<Asset>} Object returned from the server with updated metadata.
     * @example
     * asset.unarchive().then(unArchivedAsset => console.log(unArchivedAsset))
     */
