...
export default function createOrganizationApi({ http }: {
    ...
    getUsers: (query?: QueryOptions) => Promise<import("./common-types").Collection<import("./entities/user").User, import("./entities/user").UserProps>>;
    ...
    getTeams: (query?: QueryOptions) => Promise<import("./common-types").Collection<import("./entities/team").Team, TeamProps>>;
    ...
    getTeamMemberships: (opts?: {
        teamId?: string;
        query?: QueryOptions;
    }) => Promise<import("./common-types").Collection<import("./entities/team-membership").TeamMembership, TeamMembershipProps>>;
    getTeamSpaceMemberships: (opts?: {
        teamId?: string;
        query?: QueryOptions;
    }) => Promise<import("./common-types").Collection<import("./entities/team-space-membership").TeamSpaceMembership, import("./entities/team-space-membership").TeamSpaceMembershipProps>>;
